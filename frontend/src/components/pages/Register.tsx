      ...
      <div className=' w-11/12 m-auto flex flex-col items-center mt-44'>
          ...
          {/* username */}
             <div className='relative flex items-center justify-center'>
                <input className='border-2 md:w-11/12 w-full pl-14 h-9 rounded-md  ' type="text" name="username" placeholder='username' />
             ...
             <button className='border-2 bg-red-400 text-white font-bold rounded-md h-10 cursor-pointer w-40 m-auto'>Register</button>
